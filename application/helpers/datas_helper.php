...
function dataOrganizeCotacao($datas)
{
    ...
    ($datas['corretor']["correSusep"] != null ? $return['corretor']["corresusep"] = $datas['corretor']["correSusep"] : null);
    ($datas['corretor']["correNomeRazao"] != null ? $return['corretor']["corrnomerazao"] = $datas['corretor']["correNomeRazao"] : null);
    ($datas['corretor']["correCpfCnpj"] != null ? $return['corretor']["corrcpfcnpj"] = $datas['corretor']["correCpfCnpj"] : null);
    ($datas['corretor']["correDtNasci"] != null ? $return['corretor']["corrdtnasc"] = $datas['corretor']["correDtNasci"] : null);
    ($datas['corretor']["correCdSexo"] != null ? $return['corretor']["corrcdsexo"] = $datas['corretor']["correCdSexo"] : null);
    ($datas['corretor']["correCdEstCivl"] != null ? $return['corretor']["corrcdestadocivil"] = $datas['corretor']["correCdEstCivl"] : null);
    ($datas['corretor']["correProfRamoAtivi"] != null ? $return['corretor']["corrcdprofiramoatividade"] = $datas['corretor']["correProfRamoAtivi"] : null);
    ($datas['corretor']["correEmail"] != null ? $return['corretor']["corremail"] = $datas['corretor']["correEmail"] : null);
    ($datas['corretor']["correCelDdd"] != null ? $return['corretor']["corrdddcel"] = $datas['corretor']["correCelDdd"] : null);
    ($datas['corretor']["correCelNum"] != null ? $return['corretor']["corrnmcel"] = $datas['corretor']["correCelNum"] : null);
    ($datas['corretor']["correFoneDdd"] != null ? $return['corretor']["corrdddfone"] = $datas['corretor']["correFoneDdd"] : null);
    ($datas['corretor']["correFoneNum"] != null ? $return['corretor']["corrnmfone"] = $datas['corretor']["correFoneNum"] : null);
    ($datas['corretor']["correEnd"] != null ? $return['corretor']["corrnmend"] = $datas['corretor']["correEnd"] : null);
    ($datas['corretor']["correEndNum"] != null ? $return['corretor']["corrnumero"] = $datas['corretor']["correEndNum"] : null);
    ($datas['corretor']["correEndCompl"] != null ? $return['corretor']["correndcomplet"] = $datas['corretor']["correEndCompl"] : null);
    ($datas['corretor']["correEndCep"] != null ? $return['corretor']["corrcep"] = $datas['corretor']["correEndCep"] : null);
    ($datas['corretor']["correEndCidade"] != null ? $return['corretor']["corrnmcidade"] = $datas['corretor']["correEndCidade"] : null);
    ($datas['corretor']["correEndCdUf"] != null ? $return['corretor']["corrcduf"] = $datas['corretor']["correEndCdUf"] : null);
